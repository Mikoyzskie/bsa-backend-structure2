...
const {
  validateEventUpdate,
  validateEventCreate,
} = require("./middlewares/validations/events/event.validation");

const { EventValidation } = require("./middlewares/validations/validation");

// const { validateEventCreate } = require("./middlewares/validations/validation");
